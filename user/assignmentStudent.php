			...
			<div class='panel'>
				...
				<div class='middle_right'>
					<div class='middle' style='width:100%'>
						<div class='title_middle' style='margin-bottom:0pt;'><h2>Assignment</h2><?php echo $message ?></div>
							        ...
							        { 
							        	...
							        	{?>
							        		<td style='border:1px solid black;padding:5pt;' id='test' contenteditable="true">
												<button style='background:none;border:none;' onClick='assignment_view(<?php echo $row1['assign_id'] ?>);' title='<?php echo $row['assign_title']." : ".$row1['assign_total']; ?>'>Assign</button>
							    		...
							    		<td style='border:1px solid black;padding:5pt;' id='test' contenteditable="true">
												<button style='background:none;border:none;'  title='<?php echo $row['assign_title']." : ".$row1['assign_total']; ?>'>Assign</button>
											<!-- <a href="#" title='Assignment total marks : <?php echo $row1['assign_total']; ?>'>Assign</a> -->
											</td>
							    		<?php
							    		}
...
<div id="assignment_view" class='a' style="display:none; background:#F6F7F8; float:left;padding:15pt 15pt 0pt 15pt;">
						...
						<div class='form-style-2' style='margin-top:-18pt;'>
					   	...
					   	<form action='ViewAssignmentAdmin.php' method='get' enctype='multipart/form-data'>
					   		<center>
					   		<table>
					   		<tr>
