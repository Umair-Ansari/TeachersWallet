			...
			<div class='header'>
				...
				<div class='welcome_logout'>
					<div class='text_welcome_logout' >
						...
						<div class='lower_text_welcome_logout' style='color: #F3F3F3;text-shadow: 0px 0px 2px #D2EBFA;'><a href="#"  style='color: #E1E2E3;'>Home</a> | <a href="../includes/UserManagement/LogOutBL.php" style='color: #E1E2E3;'>Logout</a></div>
					</div>
				</div>
			</div><!-- header -->
			...
			<div class='panel'>
				<div class='left' style='height:850pt;'>
					...
					<div class='nav_left' style='background-color: #E1E2E3;'>
						<div class='item_nav_left' style='background-color: #E1E2E3;'>Manage Meeting</div>
