			...
			<div class='panel'>
				...
				<div class='middle_right'>
					<div class='middle' style='width:100%'>
						<div class='title_middle' style='margin-bottom: 2pt'><h2><?php if ($_GET['action'] ==  "View"){ echo "Notes"; } else {echo "<a href='notes.php?course=".$_GET['course']."&action=View' >Notes</a>>Upload Notes";}?></h2> <?php echo $message ?></div>
						<?php 
						if ($_GET['action'] ==  "View") 
						{
