			...
			<div class='panel'>
				...
				<div class='middle_right' style='width: 78%;'>
					<div class='middle' style='width:100%;overflow:scroll;'>
						<div class='title_middle' style='margin-bottom:0pt;'><h2><div class="form-style-2" style='max-width: 630px;'><form action='attendance.php'><lable style='font-size:12pt;'>Attendance</lable><a href='addAttendance.php?course=<?php echo $c_id ?>'><input type='button' value='Add Attendance' class='myButton'   style='margin-left:10pt;'></a> | Month : <input type="text" name='month' id="month" value='<?php echo date("m/Y") ?>' class='input-field'> <input type='text' value='<?php echo $c_id ?>' name='course' hidden><input type='submit'  value='View' class='myButton'></form></div></h2><?php echo $message ?></div>
