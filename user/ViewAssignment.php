				...
				<div class='middle_right'>
					<div class='middle' style='width:100%'>
						...
						if ($_GET['action'] ==  "View") 
						{
							...
							{
								echo "<center><h2 style='margin-top:5pt;margin-bttom:5pt'>No Assignment ".$_GET['case']." Case Files Found in System!</h2><br><button style='margin-left:2pt;'class='myButton' onClick=best();>Add</button></center><br>";

							}
						} else {
							
						?>
						<form action='../includes/CourseFileManagement/AddAssignmentFiles.php' method='post' enctype='multipart/form-data'>
							
							<input hidden type='text' name='course' value='<?php echo $_GET['course'] ?>'>
							<input hidden type='text' name='case' value='<?php echo $_GET['case'] ?>' />
					   		<input hidden type='text' name='assignment' value='<?php echo $_GET['assignment'] ?>' /> 
			...
			<div class='footer'><center style='color:white'>2015 Teacher's Wallet</center>
					...
					<div id="best" class='a' style="display:none; background:#F6F7F8; float:left;padding:15pt 15pt 0pt 15pt;">
						...
						<div class='form-style-2' style='margin-top:-18pt;'>
							<div class="form-style-2-heading">Adding Assignment<?php echo $_GET['case'] ?> Case Files</div>
					   	<form action='ViewAssignment.php' method='get'>
