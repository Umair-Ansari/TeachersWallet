			...
			<div class='panel'>
				...
				<div class='middle_right'>
					<div class='middle' style='width:100%'>
						<div class='title_middle' style='margin-bottom: 2pt'><h2>Comments</h2> <?php echo $message ?></div>
						<table style='width:100%;margin-top:2pt;'>
						<tr style="background-color:rgb(212, 206, 206)">
							<td style='border:1px solid black;padding:5pt;width: 20pt;'>Comments</td>
						</tr>
						<?php
						$Query_user = "SELECT ".$_GET['comment']." AS comment FROM course_student WHERE c_id = ".$_GET['course']."";
						$result_user = $database->query($Query_user);
						while ( $row_user = mysqli_fetch_assoc($result_user)) 
						{
							echo "<tr><td style='border:1px solid black;padding:5pt;width: 20pt;'>".$row_user['comment']."</td></tr>";
