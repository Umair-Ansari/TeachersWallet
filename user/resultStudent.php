				...
				<div class='middle_right'>
					<div class='middle' style='width:100%'>
						<div class='title_middle' style='margin-bottom:0pt;'><h2>Final Result</h2><?php echo $message ?></div>
									        	...
									        	$result_class = $database->query($Query_class);
									       		...
									       		{ 
										        	...
										        	$print .= "<table style='max-width:107%;margin-top:2pt;font-size:8pt;'>";								
														...
														$print .= "</tr>";
														$user = $_SESSION["user"];
														$Query_course_student     = "SELECT *  FROM course_student WHERE c_id =".$c_id." AND u_id = $user ";
														if($role == "Admin")
														{
							...
							$print .= "<center>";
								$print .= "<h2 style='margin-top:5pt;margin-bttom:5pt'>To Generate Final Result Teacher Must Add</h2><br>";
								$print .= $Error;
