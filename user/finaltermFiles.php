			...
			<div class='panel'>
				...
				<div class='middle_right'>
					<div class='middle' style='width:100%'>
						<div class='title_middle' style='margin-bottom:0pt;'><h2><a href='final.php?course=<?php echo $c_id ?>'><u>Final Term</u></a> > <?php echo $_GET['action'] ?> <?php echo $_GET['type'] ?> Case Files</h2><?php echo $message ?></div>
						<?php 
						if ($_GET['action'] ==  "View") {
						$dir = "../includes/CourseFileManagement/course_files/Finalterm/".$_GET['term']."/".$_GET['type']."/";
						$files = scandir($dir, 0);
						...
						<form action='../includes/CourseFileManagement/AddFinaltermFiles.php' method='post' enctype='multipart/form-data'>
							<input hidden type='text' name='f_id' value='<?php echo $_GET['term'] ?>'>
